  ...
  <div>
    <div class="container">
      ...
      <div class="border p-3" style="font-size: 16px">
        ...
        when you use our website, mobile applications and other online services
        (collectively, the "Flexemarket Service") or when you otherwise interact
        with us. We may change this Privacy Policy from time to time. If we make
        changes, we will notify you by revising the date at the top of the
        policy and, in some cases, we may provide you with more prominent notice
        ...
        you access the Flexemarket Service to stay informed about our
        ...
        with the Flexemarket Service, communicate with other users, provide
        reviews or other comments, purchase any services from Flexemarket,
        request customer support or otherwise communicate with us. The types of
        information we may collect include your name, email address, Flexemarket
        ...
        any bids you make on offers through the Flexemarket Service, any reviews
        ...
        prevent fraudulent transactions, tailor our content to you, offer you
        opportunities to purchase products or services that we believe may be of
        interest to you, and for any other purposes described in this Privacy
        Policy. For example, if you create or log into your account through a
        social media site, we will have access to certain information from that
        site, such as your name, account information and friends lists, in
        accordance with the authorization procedures determined by such social
        ...
        these services directly to sellers pursuant to its own terms and privacy
        policy. When signing up to receive funds electronically, Stripe, and not
        Flexemarket, collects some of the information provided by sellers via
        the Flexemarket Service, including debit card numbers, Social Security
        ...
        shared in a particular manner and you provide such information. We may
        ...
        vice versa. The use of such features enables the sharing of information
        ...
        your use of the Flexemarket Service and other websites and online
        ...
        information may be used by Flexemarket and others to, among other
        ...
        the Flexemarket Service and other websites and online services, and
        better understand your online activity. Your mobile device operating
        system may also include a feature that allows you to opt out of having
        ...
        affect third party flash cookies used in connection with the Flexemarket
        Service. To delete or disable flash cookies please visit
        ...
        identifiers (such as name, contact information, device identifiers and
        state-issued ID numbers); internet or other electronic network activity
        information (such as usage data); demographic information (such as age);
        commercial information (such as products purchased or sold); geolocation
        data; inferences (such as approximate location); visual or similar
        information (such as photographs of yourself); and other information
        that relates to or is reasonably capable of being associated with you
        and that does not fit neatly into one of the other categories (such as
        personal information contained in reviews, comments and communications
        with us). For more details about the personal information we collect,
        including the categories of sources, please see the Collection of
        Information section above. We collect personal information for the
        business and commercial purposes listed in the Use of Information
        section above. We share the personal information we collect with the
        categories of third parties listed in the Sharing of Information section
        above. Subject to certain limitations, the CCPA provides California
        residents with the right to: request to know about the personal
        information that we have collected about you in the 12 months preceding
        your request (including the categories of information collected, the
        source of that information, the business purpose of that collection, the
        categories of third parties with whom that information is shared, and
        the specific pieces of personal information collected about you);request
        to delete any personal information about you that we have
        collected;opt-out of "sales" of personal information to third parties,
        if applicable; andnot to be discriminated against for exercising these
        rights. CCPA requires that we provide transparency about personal
        information we "sell", which is broadly defined. While we don’t share
        personal information in exchange for money, we do allow Google’s online
        advertising service to collect identifiers (such as cookies and other
        device identifiers) and internet or other electronic network information
        (such as the webpage you visited) through the Flexemarket Service for
        the purpose of sending personalized ads to you. This activity may be
        considered a "sale" under California law. To opt out of this "sale",
        please visit our Do Not Sell My Personal Information page. We do not
        knowingly sell personal information about consumers under the age of 16.
        To submit a request to know or a request to delete, please send an email
        to ccpa@Flexemarket.com. In both cases, we will verify your request by
        asking you to provide information that matches information we have on
        file about you. You may designate another person as your authorized
        agent to act on your behalf with regard to CCPA requests. If you have
